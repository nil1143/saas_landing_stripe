export const features = [
    {
      ...
      text: "With nilAI, tedious tasks are history. Automation and smart processes bring your productivity to new heights. It's like having an extra cup of coffee, but without the jitters.",
      button: {
    ...
    },
    {
      ...
      text: 'Your data security is our priority. With state-of-the-art encryption and robust privacy controls, nilAI helps keeps your information secure and locked up tighter than Fort Knox.',
      button: {
  ...
  export const faq = [
    {
      id: '0',
      question: 'How easy is it to setup nilAI?',
      answer:
        'Absolutely! Not only you can upgrade your plan at any time but you also get a prorated discount giving you maximum value for your subscription.',
    },
    {
      id: '1',
      question: 'Can I integrate nilAI with other platforms?',
      answer:
        'Absolutely! Not only you can upgrade your plan at any time but you also get a prorated discount giving you maximum value for your subscription.',
    },
    {
  ...
  export const plans = [
    {
      ...
      linkMonthly: '?plan=corem',
      linkYearly: '?plan=corey'
    },
    {
      id: '1',
      title: 'Overdrive',
      ...
      linkMonthly: '?plan=overdrivem',
      linkYearly: '?plan=overdrivey'
    ...
    },
    {
      ...
      linkMonthly: '?plan=teamm',
      linkYearly: '?plan=teamy'
    },
  ];
  ...
  export const testimonials = [
    {
      ...
      comment:
        "nilAI's customer support is second to none! They’re like my tech superheroes, always there when I need them.",
    },
    {
      id: '1',
      name: 'Mark Erixon',
    ...
    },
    {
      ...
      comment:
        "Switched to nilAI last month, and I'm already seeing results. Best decision for our team!",
    },
    {
      id: '5',
      name: 'Jim Bradley',
